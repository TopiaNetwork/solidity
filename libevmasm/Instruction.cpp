...
std::map<std::string, Instruction> const solidity::evmasm::c_instructions
	= {{"STOP", Instruction::STOP},
	   ...
	   {"DBPUT", Instruction::DBPUT},
	   {"DBQUERY", Instruction::DBQUERY},
	   {"DBDELETE", Instruction::DBDELETE},
	   {"DBUPDATE", Instruction::DBUPDATE},
	   {"DBVALLEN", Instruction::DBVALLEN},
	   {"DBTEST", Instruction::DBTEST},
...
static std::map<Instruction, InstructionInfo> const c_instructionInfo
	= { //												Add, Args, Ret, SideEffects, GasPriceTier
		...
		{Instruction::DBPUT, {"DBPUT", 0, 6, 1, false, Tier::Base}},
		{Instruction::DBQUERY, {"DBQUERY", 0, 6, 2, false, Tier::Base}},
		{Instruction::DBDELETE, {"DBDELETE", 0, 4, 1, false, Tier::Base}},
		{Instruction::DBUPDATE, {"DBUPDATE", 0, 6, 1, false, Tier::Base}},
		{Instruction::DBVALLEN, {"DBVALLEN", 0, 4, 1, false, Tier::Base}},
		{Instruction::DBTEST, {"DBTEST", 0, 3, 2, false, Tier::Base}},
...
InstructionInfo solidity::evmasm::instructionInfo(Instruction _inst, langutil::EVMVersion _evmVersion)
{
	...
	catch (...)
	{
		return InstructionInfo(
			{"<INVALID_INSTRUCTION: " + to_string(static_cast<unsigned>(_inst)) + ">", 0, 0, 0, false, Tier::Invalid});
	}
}
